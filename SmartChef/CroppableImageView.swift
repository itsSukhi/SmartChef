...
class CroppableImageView: UIView, CornerpointClientProtocol
{
  ...
  var internalCropRect: CGRect? =  CGRect(x: 50, y: 50, width: 200, height: 200)
  var cropRect: CGRect?
    {
    set
    {
...
//---------------------------------------------------------------------------------------------------------
  ...
  override func layoutSubviews()
  {
    ...
    if let requiredImageSize = imageSize
    {
      ...
      imageRect = CGRect(x:( self.frame.width / 2) - (displaySize.width / 2), y: 0, width: displaySize.width, height: displaySize.height)
    }
