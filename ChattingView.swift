...
//        self.backgroundColor = UIColor (patternImage: #imageLiteral(resourceName: "background2"))
        ...
        self.chattingTableView.tableFooterView = UIView()
        self.initSizingCell()
...
//        cell?.setTransparent()
        ...
        if msg is SBDUserMessage {
            ...
            print("Get message sendder id ",sender?.userId as Any)
