...
extension SearchTextField: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell!.detailTextLabel?.text = "DETAIL TEXT"//filteredResults[(indexPath as NSIndexPath).row].subtitle
        cell!.textLabel?.attributedText = filteredResults[(indexPath as NSIndexPath).row].attributedTitle
        cell!.detailTextLabel?.attributedText = NSMutableAttributedString(attributedString: NSAttributedString(string: "     detail text"))//filteredResults[(indexPath as NSIndexPath).row].attributedSubtitle
        cell?.detailTextLabel?.textColor = UIColor.blue
        print(filteredResults[(indexPath as NSIndexPath).row].subtitle)
        print(filteredResults[(indexPath as NSIndexPath).row].title)
        print(filteredResults[(indexPath as NSIndexPath).row].attributedTitle)
        print(filteredResults[(indexPath as NSIndexPath).row].attributedSubtitle)
...
public struct SearchTextFieldItem {
    ...
    public init(title: String, subtitle: String?, image: UIImage?, posts_count:String?) {
        self.title = title
        self.subtitle = subtitle
        self.image = image
