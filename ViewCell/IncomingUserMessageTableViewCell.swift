...
class IncomingUserMessageTableViewCell: UITableViewCell {
    ...
    func setModel(aMessage: SBDUserMessage) {
        ...
        // Set Hidden false to show image
...
//        
        ...
        let abc = self.profileImageLeftMargin.constant + self.profileImageWidth.constant + self.messageContainerLeftMargin.constant + self.messageContainerLeftPadding.constant
        let bcd = self.messageContainerRightPadding.constant + self.messageDateLabelLeftMargin.constant + self.messageDateLabelWidth.constant + self.messageDateLabelRightMargin.constant
          let messageLabelMaxWidth = width-(abc+bcd)
